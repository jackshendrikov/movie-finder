...
for row in reader:
    ...
    movie = Movie(imdb_id=row[0], title=row[1], rating=r, link=row[3], votes=row[4], genres=g, cast=row[6], runtime=rt,
                  mtype=t, netflix=n, plot=row[10], keywords=row[11], year=y, poster=row[13], youtube=yt)
